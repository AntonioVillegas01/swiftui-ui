...
//  SwiftUiApp
//
//  Created by Marco Antonio García Villegas on 21/05/20.
    ...
    var body: some View {
        ZStack {
            ...
            BackCardView()
                ...
                .rotation3DEffect(Angle(degrees: showCard ? 0 : 10), axis: (x: 10.0, y: 0, z: 0.0))
                .blendMode(.hardLight)
            ...
            BackCardView()
                ...
                .rotation3DEffect(Angle(degrees: showCard ? 0 : 5), axis: (x: 10.0, y: 0, z: 0.0))
                .blendMode(.hardLight)
    ...
    var body: some View {
        VStack {
            ...
            Image("Card1")
                ...
                .frame(width: 300, height: 110.0, alignment: .top)
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of  Ipsum.")
